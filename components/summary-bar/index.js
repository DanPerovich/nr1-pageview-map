  ...
  render() {
    ...
    return (
      ...
      <Stack
          ...
          <StackItem>
            <BillboardChart className="microchart" accountId={accountId} query={`FROM PageView SELECT average(duration) as 'Page Load (sec.)' SINCE ${durationInMinutes} MINUTES AGO WHERE appName = '${appName}' ${nrqlWhere}`}/>
          </StackItem>
          <StackItem>
          ...
          <StackItem>
            <BillboardChart className="microchart" accountId={accountId} query={`FROM PageView SELECT average(networkDuration) as 'Network (sec.)' SINCE ${durationInMinutes} MINUTES AGO WHERE appName = '${appName}' ${nrqlWhere}`}/>
          </StackItem>
          <StackItem>
          ...
          <StackItem>
            <BillboardChart className="microchart" accountId={accountId} query={`FROM PageView SELECT average(backendDuration) as 'Backend (sec.)' SINCE ${durationInMinutes} MINUTES AGO WHERE appName = '${appName}' ${nrqlWhere}`}/>
          </StackItem>
          <StackItem grow>
